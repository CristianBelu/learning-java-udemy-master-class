...
public class Arrays {
	...
	public static void processArrayList() {
		...
		//Copy array list content to a new array list, method 1
		ArrayList<String> newArrayList = new ArrayList<>();
		newArrayList.addAll(groceryList.getGroceryList());
		//Copy array list content to a new array list, method 2
		ArrayList<String> nextArray = new ArrayList<String>(groceryList.getGroceryList());
		//Copy array list content to a new array list, method 3
